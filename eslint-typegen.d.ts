...
/* eslint-typegen-hash: NTYGcqiqWn */
...
export interface RuleOptions {
   ...
   * @see https://github.com/meteorlxy/eslint-plugin-prettier-vue#eslint-config
   */
  'prettier-vue/prettier'?: Linter.RuleEntry<PrettierVuePrettier>
  /**
   * Require quotes around object literal property names
  ...
  /**
   * Nodes are have function chain calls, perhaps you can refactor it.
   * @see https://github.com/zcf0508/vue-hook-optimizer/tree/master/packages/eslint/src/rules/linear-path.test.ts
   */
  'vue-hook-optimizer/linear-path'?: Linter.RuleEntry<VueHookOptimizerLinearPath>
  /**
   * There is a loop call, perhaps you can refactor it.
   * @see https://github.com/zcf0508/vue-hook-optimizer/tree/master/packages/eslint/src/rules/loop-call.md
   */
  'vue-hook-optimizer/loop-call'?: Linter.RuleEntry<VueHookOptimizerLoopCall>
  /**
   * This node may not be used in the template.
   * @see https://github.com/zcf0508/vue-hook-optimizer/tree/master/packages/eslint/src/rules/not-used.md
   */
  'vue-hook-optimizer/not-used'?: Linter.RuleEntry<VueHookOptimizerNotUsed>
  /**
...
// ----- vue-hook-optimizer/linear-path -----
type VueHookOptimizerLinearPath = []|[{
  framework?: ("vue" | "react")
  [k: string]: unknown | undefined
}]
// ----- vue-hook-optimizer/loop-call -----
type VueHookOptimizerLoopCall = []|[{
  framework?: ("vue" | "react")
  [k: string]: unknown | undefined
}]
// ----- vue-hook-optimizer/not-used -----
type VueHookOptimizerNotUsed = []|[{
  framework?: ("vue" | "react")
  [k: string]: unknown | undefined
}]
